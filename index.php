...
<body class="body--index">
  <div class="container">
    <div class="container__navbar">
      ...
      <div class="navbar__profil"><img src="src/Navbar/User.png"></div>
    </div>
    ...
    <div class="main">
      ...
      <div class="main__posts">
        <div class="posts__post1"></div>
        <div class="posts__post2"></div>
        <div class="posts__post3"></div>
        <div class="posts__post4"></div>
        <div class="posts__post5"></div>
        <div class="posts__post6"></div>
        <div class="posts__post7"></div>
        <div class="posts__post8"></div>
        <div class="posts__post9"></div>
        <div class="posts__post10"></div>
        <div class="posts__post11"></div>
        <div class="posts__post12"></div>
        <div class="posts__post13"></div>
        <div class="posts__post14"></div>
        <div class="posts__post15"></div>
        <div class="posts__post16"></div>
        <div class="posts__post17"></div>
        <div class="posts__post18"></div>
        <div class="posts__post19"></div>
        <div class="posts__post20"></div>
        <div class="posts__post21"></div>
        <div class="posts__post22"></div>
        <div class="posts__post23"></div>
        <div class="posts__post24"></div>
      </div>
    </div>
  </div>
  <footer>
